...
export default function App(){
  ...
  const route=(x)=>{
    if(["home","explore","mall","store","deal","saved","profile","business","malldashboard","admin","advertising","analytics","testing","pilot"].includes(x)) setScreen(x);
