...
export default function App(){
  ...
  const route=(x)=>{
    if(["home","explore","mall","store","deal","saved","profile","business","malldashboard","admin","advertising","analytics"].includes(x)) setScreen(x);
